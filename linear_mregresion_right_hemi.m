function [table2]= linear_mregresion_right_hemi(fnirsROI,eegROI)
...
%   
  ...
  A0= eegROI(j).data(start:255,3:4);
   
    start=start-1;
    A1= eegROI(j).data(start:255-1,3:4);
    
    start=start-1;
    
    A2=eegROI(j).data(start:255-2,3:4);
    
    start=start-1;
    
    A3= eegROI(j).data(start:255-3,3:4);
    
     start=start-1;
     
      A4= eegROI(j).data(start:255-4,3:4);
    
      start=start-1;
     
      A5= eegROI(j).data(start:255-5,3:4);
      
      start=start-1;
     
      A6= eegROI(j).data(start:255-6,3:4);
      
      start=start-1;
     
      A7=eegROI(j).data(start:255-7,3:4);
